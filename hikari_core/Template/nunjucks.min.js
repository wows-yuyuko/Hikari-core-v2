/*!
 * nunjucks 3.2.4 —— 浏览器构建（完整版，含模板编译器）
 *
 * Copyright (c) 2012-2015, James Long. All rights reserved.
 * Released under the BSD-2-Clause license; see nunjucks.LICENSE.txt (same folder).
 *
 * Vendored verbatim from the official npm package (nunjucks@3.2.4,
 * browser/nunjucks.min.js). Do not hand-edit below this banner ——
 * upgrade by re-copying that file and bumping the version above.
 *
 * 为什么用完整版而不是 nunjucks-slim：slim 不含编译器，只能跑预编译好的模板；
 * 这里要在浏览器里直接编译 Template/*.html 源码，所以需要完整版（90KB vs 37KB）。
 */
